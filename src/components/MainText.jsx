...
const MainText = () => {
  ...
  return (
    ...
    >
      <p className="text-base sm:text-lg italic font-display">Hi, I am a</p>
      <h1 className="font-display font-light text-3xl sm:text-5xl md:text-6xl mt-2 leading-[0.95] tracking-tightest">
